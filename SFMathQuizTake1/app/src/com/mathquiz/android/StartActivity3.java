...
public class StartActivity3 extends Activity {
    ...
    CountDownTimer timer = new CountDownTimer(30000,1000) {
        ...
        public void onFinish() {
            ...
            tv_bottommesage.setText(("Time is up!" + g.getNumberCorrect2() + "/" +( g.getTotalQuestions2()-1)));
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View.OnClickListener answerButtonClickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tv_score.setText(Integer.toString(g.getScore2()));
                nextTurn();
            }
        };
    ...
    private void nextTurn(){
        g.makeNewQuestion();
        int [] answer = g.getCurrentQuestion2().getAnswerArray2();
        ...
        tv_questions.setText(g.getCurrentQuestion2().getQuestionPhrase2());

        tv_bottommesage.setText(g.getNumberCorrect2() + "/" + (g.getTotalQuestions2()-1));
